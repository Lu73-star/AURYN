...
import 'package:auryn/auryn_core/memory/memory_repository.dart';
...
class LongTermMemory {
  ...
  Future<void> initialize() async {
    ...
    AurynLogger().info('Inicializado', tag: 'LongTermMemory');
  ...
  Future<int> cleanExpired() async {
    ...
    AurynLogger().info('Limpou $deleted memórias expiradas', tag: 'LongTermMemory');
